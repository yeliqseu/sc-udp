...
{
public:
  int m_packet_type;            // packet type
  int m_id;                     // packet id
  double m_time;                // packet send time
  int m_another_packet_num;     // the number of the other type packet that have been sent when sending the current packet
  int m_donoting_num;           // the number of forgone actions (i.e., do nothing) up to sending the current packet
  int m_delivered;              // the number of delivered packet up to sending the current packet
